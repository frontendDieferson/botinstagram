...
class InstagramBot:
    def __init__(self, username, password):
        ...
        self.driver = webdriver.Firefox(executable_path=r"F:\web\botinstagram\geckodriver\geckodriver.exe")
...
DiefersonBot = InstagramBot(
    "eudiefersonsoares", "0519Dieferson"
